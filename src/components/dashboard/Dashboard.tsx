      ...
      <div className="flex flex-col">
        ...
        <div className="px-[16px] mb-4">
          {user.bank_details.isLedger ? (
            <div className="border flex flex-col gap-6 bg-[#003755] text-white p-4 rounded-lg">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/dashboard/transfer" className="p-[5px_20px] rounded-full bg-white text-[#003755] text-[14px]">
                  Send money
                </Link>
              </div>
            </div>
          ) : user.bank_details.isChecking ? (
            <div className="flex flex-col justify-between gap-4 bg-[#003755] text-white p-4 rounded-lg">
              ...
              <div className="flex justify-between gap-6">
                ...
                <div className="flex flex-col gap-5">
                  <Link href="/dashboard/transfer" className="p-[5px_20px] flex rounded-full bg-white text-[#003755] text-[14px]">
                    Send money
                  </Link>
                </div>
              </div>
        ...
        <div className="p-[16px] hidden border py-8">
          <div className="flex items-center justify-center gap-3">
            <Link href="/dashboard/cards" className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#003755] rounded-full">
              <CardIcon className="w-5 h-5" /> <span>Cards</span>
            </Link>
            <Link href="/dashboard/bill-payment" className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#003755] rounded-full">
        ...
        <div className="border flex flex-col gap-4 p-6 px-4">
          <div className="border flex flex-col gap-4 rounded-2xl overflow-hidden">
            <Image src="https://i.imgur.com/JKEKKRV.jpeg" width={5000} height={5000} className="" alt="sjsusbnnsn" />

            <div className="text-[#003755] flex flex-col gap-2 p-3 px-7 pb-7">
              <p className="font-bold text-lg">Money worries</p>
              <p> If you're concerned about the rising cost of living, or need help making repayments, we can help.</p>
            </div>
          </div>
          <div className="border flex flex-col gap-4 rounded-2xl overflow-hidden">
            <Image src="https://i.imgur.com/A8Q4E7C.png" width={5000} height={5000} className="" alt="sjsusbnnsn" />

            <div className="text-[#003755] flex flex-col gap-2 p-3 px-7 pb-7">
              <p className="font-bold text-lg">Payments</p>
              <p>Need help setting up one-off payments, Direct Debits or standing orders? Make it easy with eBanking.</p>
            </div>
          </div>
        </div>
      </div>
